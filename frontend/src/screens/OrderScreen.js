...
const OrderScreen = ({match }) => {
    ...
    if (!loading) {
        ...
        order.itmesPrice = addDecimals(order.orderItems.reduce((acc, item) => acc + item.price * item.qty, 0));
    }
            ...
            <Col md={8}>
             <ListGroup varient = "flush">
                 <ListGroup.Item>
                     ...
                     {order.isDelievered ? (<Message variant= 'success'> {order.delieveredAt} </Message>):
